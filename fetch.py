#!/usr/bin/env python3
"""
Recuperation des codes promo Boohoo depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/boohoo.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/boohoo.com"
STORE_NAME = "Boohoo"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Boohoo depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-boohoo)"
    }
    try:
